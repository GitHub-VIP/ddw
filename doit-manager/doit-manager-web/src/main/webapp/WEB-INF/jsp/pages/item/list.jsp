...
<div class="weadmin-body">
    ...
    <div class="weadmin-block demoTable">
        ...
        <button class="layui-btn" onclick="WeAdminShow('添加商品','./add',500,400)">
    ...
    <script type="text/html" id="operateTpl">
        <button class="layui-btn">
            <a title="编辑" onclick="WeAdminEdit('编辑','./edit', '{{d.id}}', 500, 400)" href="javascript:;">
    ...
    <script type="text/html" id="myTpl">
        <div class="layui-form">
            <input type="checkbox" name="itemStatus" id="itemStatus" lay-filter="status" lay-skin="switch"
                   value="{{d.status}}" lay-text="正常|下架" {{1==d.status?'checked':''}}/>
        </div>
    </script>
